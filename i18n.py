...
UI_TEXTS = {
    "pl": {
        ...
        "search_fail": "⚠️ *Nie znaleziono takiego miejsca.*\n\nSprawdź, czy nie ma literówki. Czasami pomaga podanie samej nazwy miejscowości i kodu pocztowego (bez dokładnego adresu).",
